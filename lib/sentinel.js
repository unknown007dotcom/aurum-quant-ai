...
export const Sentinel = {
    ...
    checkFailureStreak(history) {
        ...
        let streak = 0;
        // History is most-recent-first (index 0 is newest)
        // Take the 3 most recent signals
        const recent = history.slice(0, SENTINEL_CONFIG.MAX_FAILURE_STREAK);
        ...
        for (const entry of recent) {
            ...
            if (outcome === 'loss' || outcome === 'sl') {
                ...
                // If it's pending or neutral, we don't count it towards streak nor break it
                // unless we want to be very strict. For now, we only care about confirmed losses.
            }
        }
